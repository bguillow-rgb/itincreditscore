---
title: "Hard Inquiries With an ITIN: Do They Hurt Your Score?"
description: "Yes, hard inquiries hurt your ITIN credit score slightly. Learn what triggers one, how many points you lose, and how to protect your score while building credit."
tier: detail
targetQuery: "do hard inquiries affect your credit score with an ITIN"
relatedQueries:
  - "hard inquiry ITIN credit report"
  - "does applying for credit hurt ITIN score"
  - "how long do hard inquiries stay on ITIN credit report"
  - "soft inquiry vs hard inquiry ITIN"
...
faqs:
  ...
  - q: "How many points does a hard inquiry take off an ITIN credit score?"
    a: "A single hard inquiry typically reduces your score by fewer than 5 points. The exact drop depends on your overall credit profile. The fewer accounts and the shorter your history, the more noticeable the dip can feel in the early months of building credit."
  - q: "How long does a hard inquiry stay on an ITIN credit report?"
    a: "Hard inquiries remain on your credit report for up to two years. However, most scoring models stop factoring them into your score after about twelve months, so the practical impact fades well before they actually disappear from the file."
  - q: "If I apply for a credit-builder loan and a secured card in the same month, how much will my ITIN score drop?"
    a: "Two hard inquiries in close succession could lower your score by a combined 5-10 points temporarily. Because each inquiry is a small, recoverable hit and both accounts will begin building positive payment history right away, the net effect on your score is usually positive within a few months."
  - q: "Does rate-shopping for a loan produce multiple hard inquiries on an ITIN credit report?"
    a: "No, as long as the applications are for the same loan type and submitted within a defined window, typically 14-45 days depending on the scoring model. FICO and VantageScore both treat multiple mortgage or auto loan inquiries made in that window as a single inquiry, so shopping for the best rate does not multiply the score impact."
published: true
---
...
You can see every hard inquiry on your credit report when you request your file from the bureaus. If you spot one you do not recognize, that could indicate a fraudulent application in your name, which is one more reason to [monitor your credit actively](https://itincreditusa.com/credit-monitoring-with-itin).
...
However, not every product works this way. Some lenders do run a hard pull even for secured products. The safest approach is to confirm with the lender before you apply. If you are evaluating a [credit-builder loan](https://itincreditusa.com/credit-builder-loan-with-itin), ask directly. One email or phone call can save you a 5-point drop you did not need to take.
...
**Start with accounts that skip the hard pull.** Several products built for new credit builders do not require a hard check at all. Once those accounts have been open for six or more months and are [raising your score](https://itincreditusa.com/how-to-raise-credit-score-with-itin), adding a second account with a hard pull costs less because you now have more positive history to cushion the dip.

**Monitor your report for unauthorized inquiries.** According to the CFPB, you have the right to dispute any inquiry you did not authorize. Under the Fair Credit Reporting Act (FCRA), you are entitled to one free credit report per year from each bureau, and if you spot a hard inquiry you do not recognize, you can dispute it in writing. Unauthorized inquiries may also signal identity theft, which is a real risk for ITIN holders whose number could be misused. Our guide to [disputing credit report errors with an ITIN](https://itincreditusa.com/how-to-dispute-credit-report-errors-with-itin) walks through the exact dispute process for each bureau.
