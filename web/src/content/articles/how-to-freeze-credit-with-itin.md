---
title: "How to Freeze Your Credit With an ITIN (2026 Guide)"
description: "Yes, ITIN holders can freeze all 3 credit bureaus for free. Learn exactly how to place, lift, and manage a credit freeze without an SSN in 2026."
tier: detail
targetQuery: "how to freeze your credit with an ITIN"
relatedQueries:
  - "can I freeze my credit without an SSN"
  - "credit freeze ITIN holder"
  - "how to place a security freeze with an ITIN"
  - "does a credit freeze hurt your credit score ITIN"
...
faqs:
  ...
  - q: "Does a credit freeze hurt my credit score?"
    a: "No. Placing, lifting, or removing a security freeze has no impact on your credit score whatsoever. Your existing accounts continue to report payment activity normally, and lenders with whom you already have accounts can still access your file for account-management purposes."
  - q: "How long does a credit freeze last for an ITIN holder?"
    a: "A security freeze stays in place indefinitely until you lift or remove it yourself. It does not expire automatically. You will need to temporarily lift it any time you want to apply for new credit, which you can do online or by phone in as little as one hour."
  - q: "What is the difference between a credit freeze and a fraud alert for ITIN holders?"
    a: "A credit freeze completely blocks new lenders from pulling your credit report to open an account. A fraud alert leaves your report accessible but asks lenders to take extra steps to verify your identity before granting credit. An initial fraud alert lasts one year and, when placed at one bureau, automatically notifies the other two. A freeze must be placed at all three bureaus individually."
  - q: "Will a credit freeze stop all identity theft?"
    a: "No. A freeze is highly effective at preventing new fraudulent credit accounts from being opened in your name, but it does not protect against account takeovers on existing accounts, tax fraud, or medical identity theft, since those don't require a credit check. Pairing a freeze with ongoing credit monitoring gives you more complete protection."
published: true
---
...
| Bureau | Online with ITIN? | Phone | Mail Address |
|---|---|---|---|
| Equifax | Yes (myEquifax account, enter ITIN in SSN field) | (888) 298-0045 | P.O. Box 105788, Atlanta, GA 30348 |
| Experian | Sometimes (may need mail if verification fails) | (888) 397-3742 | P.O. Box 9554, Allen, TX 75013 |
| TransUnion | Yes (TransUnion Service Center account) | (800) 916-8800 | P.O. Box 2000, Chester, PA 19016 |
