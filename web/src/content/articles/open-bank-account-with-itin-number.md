---
title: "Can You Open a Bank Account With an ITIN? (2026)"
description: "Yes, you can open a U.S. bank account with an ITIN. Learn which banks accept ITIN numbers, what documents to bring, and how a bank account helps you build credit."
tier: detail
targetQuery: "can I open a bank account with an ITIN number"
relatedQueries:
  - "banks that accept ITIN numbers"
  - "how to open a bank account without SSN"
  - "does a bank account help build credit with ITIN"
  - "bank account ITIN requirements"
  - "credit union ITIN bank account"
quickAnswer: "Yes, you can open a U.S. bank account with an ITIN number. Major banks like Bank of America, Chase, Wells Fargo, and Citibank accept ITINs at their branches, as do many credit unions. A bank account does not directly build your credit score, but it is the essential first step toward getting a secured card or credit-builder loan that does."
...
faqs:
  ...
  - q: "Does opening a bank account with an ITIN build credit?"
    a: "Not directly. Banks do not report checking or savings account activity to the credit bureaus. However, a bank account establishes your financial footprint and is typically required before you can open a secured credit card or credit-builder loan, both of which do build credit."
  - q: "What documents do I need to open a bank account with an ITIN?"
    a: "You will typically need: your ITIN (or IRS ITIN assignment letter), one or two government-issued photo IDs (a foreign passport is ideal since it proves both identity and foreign status in one document), and proof of a U.S. address such as a utility bill or lease agreement. Requirements vary by institution, so call ahead."
  - q: "Which credit unions accept ITIN numbers for bank accounts?"
    a: "Many community and immigrant-focused credit unions accept ITINs, and some are more flexible than large national banks, accepting consular ID cards like the Mexican Matrícula Consular alongside or instead of an ITIN. Search for credit unions in your area that advertise service to immigrant communities, or ask a local branch directly."
  - q: "What happens if I let my bank account go negative or unpaid?"
    a: "Opening a checking account itself does not affect your credit score. However, if unpaid fees or a negative balance are sent to a collections agency, that collection account can appear on your credit report and hurt your score. Always keep enough in your account to cover fees and avoid overdrafts."
  - q: "Can I send money internationally from a U.S. bank account opened with an ITIN?"
    a: "Yes. Most major banks that accept ITINs also allow international wire transfers from those accounts. Banks like Wells Fargo offer international wire services, and some credit unions provide competitive transfer rates as well. Fees and limits vary by institution."
published: true
---
...
|---|---|---|
| ITIN (or IRS assignment letter) | Tax identity, substitute for SSN | Bring the original IRS letter if you don't have a card |
| Foreign passport (unexpired) | Identity + foreign status in one document | Strongest single ID you can carry |
| Consular ID (e.g., Matrícula Consular) | Identity | Accepted at many credit unions and some banks |
| Utility bill or lease (in your name) | U.S. address | Must be current, usually within 60-90 days |
| National ID card from your home country | Identity | May be accepted as a secondary document |
...
In practical terms, most secured card issuers and [credit builder loan](https://itincreditscore.com/credit-builder-loan-with-itin) providers require you to have an active checking or savings account before they will approve you. Having a checking or savings account at the same institution where you are applying for a credit card dramatically improves your chances. Many banks that accept ITIN for bank accounts also accept it for credit cards.
...
Once you have that bank account and are ready to generate an actual score, check out our guide on [how to build credit with an ITIN number](https://itincreditscore.com/how-to-build-credit-with-itin-number) for the full step-by-step plan.
...
2. Apply for a [secured credit card for ITIN holders](https://itincreditscore.com/secured-credit-cards-for-itin-holders) or a credit-builder loan.
...
For ITIN holders pursuing homeownership, lenders often require bank statements spanning 12-24 months to verify income and reserves, especially for non-QM or [ITIN mortgage loan](https://itincreditscore.com/itin-mortgage-loan) programs. The longer your account history, the stronger your application. Opening your account today, even before you are ready to buy, is a smart move.
...
| Institution Type | ITIN Accepted? | In-Person Required? | Credit-Building Add-on Available? |
|---|---|---|---|
| Large national banks (BofA, Chase, Wells Fargo, Citibank) | Yes | Usually yes | Yes (secured cards) |
| Community banks | Often yes | Often yes | Varies |
| Credit unions | Often yes, may also accept consular ID | Sometimes | Yes (credit-builder loans common) |
| Neobanks (e.g., Current) | Yes (select apps) | No, fully online/app | Limited (debit-based credit building) |

The bottom line: getting a U.S. bank account with your ITIN is not only possible, it is the practical starting line for everything else in your financial life here. Once your account is open and active, your next move is a [credit card that accepts ITIN](https://itincreditscore.com/credit-cards-that-accept-itin) or a credit-builder loan so you can start generating the score that opens bigger doors.
