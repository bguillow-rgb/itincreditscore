---
title: "Credit Cards That Accept ITIN Numbers (2026 Guide)"
description: "Yes, you can get a credit card with an ITIN. Discover which major issuers accept ITIN applications, what documents you need, and which card types to start with."
tier: detail
targetQuery: "credit cards that accept ITIN"
relatedQueries:
  - "can I apply for a credit card with an ITIN"
  - "what credit cards can ITIN holders get"
  - "how to get a credit card without SSN"
  - "ITIN credit card application 2026"
  - "unsecured credit card with ITIN"
quickAnswer: "Yes, several major U.S. credit card issuers accept an ITIN in place of an SSN. Capital One, Bank of America, Citi, Wells Fargo, and American Express all accept ITIN applications on select cards. If you have no U.S. credit history yet, start with a secured or no-credit-check card before applying for rewards products."
...
faqs:
  ...
  - q: "Does applying for a credit card with an ITIN hurt my credit score?"
    a: "Most credit card applications trigger a hard inquiry, which can temporarily lower your score by roughly 5 to 15 points. Cards that skip the credit check entirely, like OpenSky, have zero impact on your score when you apply."
  - q: "Which major banks accept an ITIN for credit card applications?"
    a: "Capital One, Bank of America, Citi, Wells Fargo, and American Express all accept ITINs on select cards. Having an existing checking or savings account with a bank before applying significantly improves your approval odds."
  - q: "What documents do I need to apply for a credit card with an ITIN?"
    a: "You'll typically need your ITIN letter from the IRS, a government-issued photo ID (such as a passport or consular ID), proof of a U.S. address (utility bill, lease, or bank statement), and proof of income. Some issuers also require a U.S. phone number that can receive an SMS one-time passcode, a VoIP number will not work."
  - q: "How long until I can qualify for an unsecured rewards card using an ITIN?"
    a: "Most ITIN holders who start with a secured card and pay on time every month reach a score in the 680-720 range after about 12 months, the typical threshold for applying for unsecured rewards cards from Capital One, Chase, or American Express."
  - q: "Can I become an authorized user on someone else's card if I have an ITIN?"
    a: "Yes. Major issuers including Chase, American Express, Bank of America, and Capital One allow you to be added as an authorized user using your ITIN or just your name and date of birth. The primary cardholder's payment history then appears on your credit report, helping you build credit faster."
published: true
---
...
| Issuer | Accepts ITIN? | Best starting card | Notes |
|---|---|---|---|
| Capital One | ✅ Yes | Platinum Secured | Pre-qualification tool available (soft pull) |
| Bank of America | ✅ Yes | BofA Secured | Existing account improves approval odds |
| Citi | ✅ Yes | Citi Secured Mastercard | Easier with existing Citi banking relationship |
| Wells Fargo | ✅ Yes | Secured Credit Card | Reports to all 3 bureaus; upgrade path available |
| American Express | ✅ Yes (select cards) | Varies by profile | Requires established U.S. credit history |
| Chase | ✅ Yes (select cards) | Freedom Unlimited (670+ score needed) | Needs prior U.S. credit history |
| OpenSky | ✅ Yes | OpenSky Secured Visa | No credit check; $200 refundable deposit |
...
And if you eventually receive an SSN, you don't lose the credit history you built. Our guide on [how to transfer your ITIN credit history to an SSN](/transfer-itin-credit-history-to-ssn) walks through the exact process for merging the two files at each bureau.
