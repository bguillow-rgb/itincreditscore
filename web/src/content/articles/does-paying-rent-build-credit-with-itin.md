---
title: "Does Paying Rent Build Credit With an ITIN? (2026)"
description: "Yes — rent payments can build U.S. credit with an ITIN. Learn which rent reporting services work without an SSN, which bureaus they report to, and what to expect."
tier: detail
targetQuery: "does paying rent build credit with an ITIN"
relatedQueries:
  - "rent reporting service for ITIN holders"
  - "how to report rent to credit bureau without SSN"
  - "best rent reporting service no SSN required"
  - "can ITIN holders use Experian Boost"
...
faqs:
  ...
  - q: "Which credit bureaus does rent reporting affect for ITIN holders?"
    a: "It depends on the service. Self and Boom report to all three major bureaus (Equifax, Experian, and TransUnion). Rental Kharma reports to Equifax and TransUnion only. For the broadest impact on your credit file, choose a service that covers all three."
  - q: "How much can my credit score increase by reporting rent?"
    a: "Results vary. Boom reports that its customers see an average score increase of 28 points in the first two weeks, with some seeing gains of 105 points or more. The boost is largest when rent is the only payment history on your file — which is common for new ITIN holders just starting out."
  - q: "Does Experian Boost work for ITIN holders?"
    a: "Experian Boost typically requires you to log into Experian's online portal and verify your identity — a process designed around SSNs. Most ITIN holders encounter identity verification errors online. The mail-based request process to Experian works for ITIN holders, but Experian Boost's self-serve online tool generally does not."
  - q: "Can late rent payments hurt my credit score if I sign up for rent reporting?"
    a: "Yes, potentially. Most services only submit positive payment data, but if you miss a payment while enrolled, some platforms — especially those that route payments through their system — may report a late or missed payment. Boom uses positive-only reporting, meaning missed payments are not forwarded. Always confirm your service's late-payment policy before enrolling."
  - q: "Do I need my landlord's permission to report my rent to the credit bureaus?"
    a: "Not always. Services like Self and Boom verify rent by scanning your linked bank account for recurring payments — no landlord contact needed. Rental Kharma does require landlord verification to set up and maintain reporting. If your landlord is unresponsive, choose a bank-verification service instead."
published: true
---
...
| Service | Bureaus Reported | SSN Required? | Landlord Needed? | Monthly Cost | Retroactive Reporting |
|---|---|---|---|---|---|
| **Self** | Equifax, Experian, TransUnion | No (ITIN-compatible) | No | Free (basic) | $49.95 one-time (up to 24 mo.) |
| **Boom** | Equifax, Experian, TransUnion | Verify directly | No | ~$3/mo | $25 one-time (up to 24 mo.) |
| **Ava** | Equifax, Experian, TransUnion | No (built for immigrants) | No | Subscription | Limited |
| **Rental Kharma** | Equifax, TransUnion | No (name/DOB match) | Yes (initial setup) | $8.95/mo + $75 setup | All past payments at current address |
| **RentReporters** | Equifax, TransUnion, Experian | Confirm directly | Yes | ~$9.95/mo | Up to 4 years |
