---
title: "How to Transfer Your ITIN Credit History to an SSN"
description: "Yes, your ITIN credit history transfers to your new SSN, but it's not automatic. Learn the exact 4-step process to protect every month of credit you built."
tier: detail
targetQuery: "how to transfer ITIN credit history to SSN"
relatedQueries:
  - "move credit history from ITIN to social security number"
  - "will my ITIN credit score carry over to SSN"
  - "does credit history follow you from ITIN to SSN"
  - "ITIN to SSN credit transfer bureaus"
  - "how long does ITIN credit transfer take"
quickAnswer: "Your ITIN credit history does NOT transfer automatically when you get an SSN. You must: (1) notify the IRS to rescind your ITIN, (2) update your lenders with your new SSN, and (3) write all three credit bureaus requesting the merge. The process typically takes 30-60 days and should not hurt your score."
...
faqs:
  ...
  - q: "Does the credit bureau transfer happen automatically when I get an SSN?"
    a: "No. Your ITIN credit history is not automatically transferred. You must proactively contact all three bureaus, Experian, TransUnion, and Equifax, in writing to request the merge. Without this step, your credit file may sit orphaned under your old ITIN."
  - q: "Do I need to rescind my ITIN before requesting the credit transfer?"
    a: "Yes. According to IRS rules, you cannot hold an active ITIN and an active SSN at the same time. Contact the IRS first to have your ITIN rescinded, get written confirmation, then use that letter when writing to the credit bureaus."
  - q: "How long does it take the credit bureaus to merge my ITIN and SSN files?"
    a: "Most credit bureaus complete the transfer within 30-60 days of receiving your written request. The agencies may send you a confirmation letter; if they ask for additional documents, respond quickly to avoid delays."
  - q: "What documents do I need to send the credit bureaus for the ITIN-to-SSN transfer?"
    a: "You'll typically need: your full legal name, old ITIN, new Social Security card (or SSN confirmation), a government-issued photo ID, proof of current address (utility bill or bank statement), and a copy of the IRS letter confirming your ITIN was rescinded."
published: true
---
...
Once the transfer is complete, the same credit-building rules apply as they did under your ITIN. If you want to understand how your score is calculated or explore tools to keep building from your existing file, our guides on [how to build credit with an ITIN number](/articles/how-to-build-credit-with-itin-number) and [credit builder loans with an ITIN](/articles/credit-builder-loan-with-itin) walk through what moves the needle most, and our [complete ITIN credit score guide](/itin-credit-score-guide) ties it all together.
