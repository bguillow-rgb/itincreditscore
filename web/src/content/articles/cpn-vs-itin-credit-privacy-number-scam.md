---
title: "CPN vs ITIN: One Is Legal, One Is Federal Fraud"
description: "A CPN is a scam product; using one on a credit application is federal fraud. An ITIN is a real IRS tax ID you can legally build credit with. Know the difference."
tier: cluster
targetQuery: "is a CPN legal"
relatedQueries:
  - "CPN vs ITIN"
  - "credit privacy number scam"
  - "what is a CPN number"
  - "can I use a CPN to build credit"
  - "difference between CPN and ITIN"
quickAnswer: "An ITIN is a real tax ID issued by the IRS, and building credit with it is legal. A CPN is a nine-digit number sold by scammers as a substitute SSN. No government agency issues CPNs, and putting one on a credit application is federal fraud, whatever the seller claims."
...
faqs:
  ...
  - q: "What is the difference between a CPN and an ITIN?"
    a: "An ITIN is issued by the IRS to people who need to file U.S. taxes but do not qualify for an SSN. It is legal and verifiable, and many lenders and all three credit bureaus accept it. A CPN comes from a private seller with no agency behind it, and the number itself is often a stolen or fabricated SSN."
  - q: "Can I go to prison for using a CPN?"
    a: "Yes. Using a CPN in place of an SSN can be charged as false representation of a Social Security number and as a false statement on a credit application, with identity theft charges added when the number belongs to a real person. Federal prosecutors have brought cases against both CPN sellers and the people who used the numbers."
  - q: "I already paid for a CPN. What should I do now?"
    a: "Stop using it immediately and do not put it on any new application. Report the seller at ReportFraud.ftc.gov. If the number turns out to be a real person's SSN, or your own information was misused in the process, follow the recovery steps at IdentityTheft.gov. If you already used it on applications, talk to an attorney before doing anything else."
  - q: "Can I build a real credit score with just an ITIN?"
    a: "Yes. All three credit bureaus can build a file under an ITIN, and lenders that accept ITIN applicants report your payment history the same way they would for an SSN holder. Secured cards and credit-builder loans both work, and so does rent reporting. It takes about six months of reported history to generate a first score."
published: true
---
...
The difference that matters for your credit: an ITIN is verifiable. When you apply for a secured card or a credit-builder loan with a lender that accepts ITINs, you are telling the lender the truth about who you are. Experian, Equifax, and TransUnion can all maintain a credit file for an ITIN holder, and payment history reported under your ITIN builds a genuine score. Our guide to [building credit history with an ITIN](/build-credit-history-with-itin) walks through the full path, and if you do not have a number yet, start with [how to get an ITIN](/how-to-get-an-itin).
...
<aside class="scam-shield">
  <span class="ss-label">CPN red flags</span>
  <ul>
    <li>"New credit file" or "fresh start" for a fee. No legal product does this.</li>
    <li>"Tradelines included" with the number. Fabricated history on a fake file.</li>
    <li>"100% legal loophole" or "attorneys create these." No statute backs any of it.</li>
    <li>Payment by Zelle, CashApp, or crypto only. That is a seller planning to disappear.</li>
  </ul>
  <p class="ss-note">We never sell CPNs, charge fees, or guarantee approval. If someone asks for money up front to give you a "new" credit number, walk away and report them at ReportFraud.ftc.gov.</p>
</aside>
...
The person hit hardest is often the one whose SSN got resold. If you want to understand what that side of it looks like, our guide on [identity theft and your ITIN credit file](/articles/identity-theft-itin-credit-score) covers how stolen identities surface on credit reports and how victims dig out.
...
The sequence that works: open a [secured credit card that accepts ITIN applicants](/articles/secured-credit-card-credit-score-itin), then add a [credit-builder loan](/articles/credit-builder-loan-with-itin) so your file shows both revolving and installment history. Keep utilization low and let the on-time payments accumulate. A first score usually appears within six months of your first reported account. Our full walkthrough of [how to build credit with an ITIN number](/articles/how-to-build-credit-with-itin-number) covers each step, including which lenders report to all three bureaus.
...
**Is a CPN ever legal to use?**
No federal or state agency issues CPNs, so there is no legal way to obtain one. Entering a CPN in the SSN field of a credit application misrepresents your identity to a lender, which is a federal crime regardless of what the seller told you. The FTC classifies CPN offers as credit repair fraud.

**What is the difference between a CPN and an ITIN?**
An ITIN is issued by the IRS to people who need to file U.S. taxes but do not qualify for an SSN. It is legal and verifiable, and many lenders and all three credit bureaus accept it. A CPN comes from a private seller with no agency behind it, and the number itself is often a stolen or fabricated SSN.

**Can I go to prison for using a CPN?**
Yes. Using a CPN in place of an SSN can be charged as false representation of a Social Security number and as a false statement on a credit application, with identity theft charges added when the number belongs to a real person. Federal prosecutors have brought cases against both CPN sellers and the people who used the numbers.

**I already paid for a CPN. What should I do now?**
Stop using it immediately and do not put it on any new application. Report the seller at ReportFraud.ftc.gov. If the number turns out to be a real person's SSN, or your own information was misused in the process, follow the recovery steps at IdentityTheft.gov. If you already used it on applications, talk to an attorney before doing anything else.

**Can I build a real credit score with just an ITIN?**
Yes. All three credit bureaus can build a file under an ITIN, and lenders that accept ITIN applicants report your payment history the same way they would for an SSN holder. Secured cards and credit-builder loans both work, and so does rent reporting. It takes about six months of reported history to generate a first score.
