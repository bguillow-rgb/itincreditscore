---
title: "Best Secured Credit Cards for ITIN Holders (2026)"
description: "Yes, ITIN holders can get secured credit cards. Compare the top cards—OpenSky, Capital One, Current Build—with deposits, fees, and bureau reporting."
tier: detail
targetQuery: "secured credit cards for ITIN holders"
relatedQueries:
  - "best credit card for ITIN holders no SSN"
  - "credit card without social security number immigrant"
  - "how to get a credit card with ITIN number"
  - "secured credit card ITIN no credit check"
...
faqs:
  ...
  - q: "Do secured cards for ITIN holders report to all three credit bureaus?"
    a: "The best ones do. OpenSky, Capital One Platinum Secured, and the Current Build Card all report to Experian, TransUnion, and Equifax every month. Always confirm bureau reporting before you apply — a card that only reports to one bureau builds only one-third of your credit profile."
  - q: "How long does it take to get a credit score after opening a secured card with an ITIN?"
    a: "Most ITIN holders see a VantageScore within one to two months of their first account appearing on a bureau report. A FICO score — the one most lenders actually use — requires at least one account that is six months old with recent reported activity. Plan for a 3–6 month window before a usable score appears."
  - q: "How much do I need to deposit for a secured card as an ITIN holder?"
    a: "Minimums vary by card. The OpenSky Secured Visa starts at $200; Capital One Platinum Secured can be as low as $49 depending on your profile; the Current Build Card requires no deposit at all. Your deposit usually becomes your credit limit, so depositing more (e.g., $500) gives you a higher limit and makes it easier to stay under the 30% utilization threshold."
  - q: "Will getting a secured card with an ITIN help if I later receive an SSN?"
    a: "Yes — but you must take action. Credit history is not automatically transferred from an ITIN file to a new SSN file. Once you receive an SSN, write to all three credit bureaus requesting that your credit history be merged. Include your ITIN, new SSN, government-issued ID, and proof of address. Most bureaus process the transfer within two to four weeks."
  - q: "Can undocumented immigrants get a secured credit card with an ITIN?"
    a: "Yes. An ITIN is available regardless of immigration status — the IRS issues it to anyone with a U.S. tax obligation. Major issuers including Chase, Capital One, and Bank of America accept ITIN applications. If you are just starting out with no U.S. credit history, a secured card with no credit check (like OpenSky or Current Build) is the most accessible entry point."
published: true
---
...
| Card | Min. Deposit | Annual Fee | Credit Check? | Reports to All 3 Bureaus | Best For |
|---|---|---|---|---|---|
| **OpenSky Secured Visa** | $200 | $35 | No | ✅ Yes | Zero U.S. credit history, any ITIN holder |
| **OpenSky Plus Secured Visa** | $300 | $0 | No | ✅ Yes | Savers who want no annual fee |
| **Capital One Platinum Secured** | $49–$200 | $0 | Soft pull | ✅ Yes | ITIN holders with some credit activity |
| **Current Build Card** | $0 | $0 | No | ✅ Yes | No-deposit option, debit-style spending |
| **Bank of America Secured** | $200 | $0 | Soft pull | ✅ Yes | Existing BofA banking customers |
| **Self Visa Credit Card** | $100 | $0 yr 1, $25 after | No | ✅ Yes | Pairing a card with a credit-builder loan |
