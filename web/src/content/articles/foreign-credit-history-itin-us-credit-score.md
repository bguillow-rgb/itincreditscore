...
relatedQueries:
  - "can I use foreign credit history to build US credit with ITIN"
  - "Nova Credit ITIN holder"
  - "international credit score transfer ITIN"
  - "how to start US credit history as an immigrant with ITIN"
...
faqs:
  ...
  - q: "Can I use Nova Credit's Credit Passport with an ITIN instead of an SSN?"
    a: "Yes. When applying with a participating lender like Chase, you may provide your ITIN where an SSN is requested. The lender then routes your application through Nova Credit's Credit Passport to evaluate your foreign credit history."
  - q: "Does using Nova Credit give me a U.S. credit score?"
    a: "No. Nova Credit's Credit Passport helps a specific lender make an approval decision using your foreign history, but it does not generate or add to a U.S. credit file. You still need U.S. tradelines reporting to the bureaus to build an actual FICO or VantageScore."
  - q: "What if my home country is not supported by Nova Credit?"
    a: "You start from scratch with ITIN-friendly credit-building products: a secured card or a credit-builder loan that reports to all three U.S. bureaus. Most people can generate a scoreable U.S. file within 3-6 months of opening that first account."
  - q: "How long does it take an ITIN holder with no prior U.S. credit to get a first score?"
    a: "Typically 3-6 months of reported account activity is enough for the bureaus to generate a score. According to one 2026 study on immigrant credit, 75% of immigrant consumers who arrive with no U.S. file achieve a credit score by age 26, even when they start with nothing."
published: true
---
...
| Scenario | Gets you a U.S. credit score? | Timeline to first score | Requires strong foreign history? | Works for all ITIN holders? |
|---|---|---|---|---|
| Nova Credit Credit Passport | No (helps approval only) | Immediate approval possible, score still takes 3-6 months | Yes | No (country-dependent) |
| Secured card (ITIN-accepted) | Yes, after 3-6 months | 3-6 months | No | Yes |
| Credit-builder loan (ITIN-accepted) | Yes, after 3-6 months | 3-6 months | No | Yes |
| Nova Credit + U.S. tradeline | Yes, after 3-6 months | Fastest combined path | Yes for Nova portion | No (country-dependent) |
| Authorized user on family member's account | Yes, often immediately | Days to weeks | No | Yes (if primary user reports) |
