---
title: "Authorized User Status With an ITIN: How It Builds Credit"
description: "Yes, you can be added as an authorized user with an ITIN. Learn how it affects your credit score, which issuers allow it, and what to watch out for."
tier: detail
targetQuery: "can I be added as an authorized user with an ITIN"
relatedQueries:
  - "does authorized user status build credit with ITIN"
  - "how to build credit as authorized user without SSN"
  - "authorized user credit card ITIN no SSN"
  - "does being an authorized user affect credit score ITIN holder"
...
faqs:
  ...
  - q: "Will the authorized user account actually show up on my ITIN credit file?"
    a: "It depends on whether the issuer reports authorized users to the bureaus and whether they can correctly match the account to your credit file. Providing your ITIN when you are added significantly improves the chance of a successful match. According to legalclarity.org, if the issuer cannot match your identifying details to a credit file, the account may never appear on your report."
  - q: "How quickly can authorized user status improve my credit score?"
    a: "If the issuer reports to the bureaus, the account typically appears on your credit report within 30-45 days. A thin-file ITIN holder added to a card with a long, clean history may see a meaningful score increase once that tradeline posts, because it immediately adds positive payment history and account age."
  - q: "Can the primary cardholder's late payments hurt my ITIN credit score?"
    a: "Yes, at most bureaus. If the primary cardholder misses a payment, that negative mark can appear on your credit report too. One exception: Experian has stated it does not include negative information from authorized user accounts on the authorized user's own report, though TransUnion and Equifax may. Choosing a primary cardholder with a reliable payment record is essential."
  - q: "Is authorized user status enough on its own to build a strong credit score?"
    a: "Probably not on its own. Lenders reviewing your report can see that the account is an authorized user tradeline rather than a primary account, which carries less weight. For the best results, combine authorized user status with at least one account in your own name, such as a credit builder loan or a secured card that accepts ITINs."
published: true
---
...
| Issuer | SSN Required for AU? | Reports to All 3 Bureaus? |
|---|---|---|
| Capital One | No | Yes |
| Chase | No | Yes |
| Citi | No | Yes |
| Barclays | No | Yes |
| American Express | SSN or ITIN required | Yes |
| Bank of America | Varies by card | Yes |
| Discover | SSN required | Yes |
| Wells Fargo | Varies | Yes |
