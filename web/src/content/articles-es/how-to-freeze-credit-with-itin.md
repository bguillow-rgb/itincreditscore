---
title: "Cómo congelar tu crédito con un ITIN (Guía 2026)"
description: "Sí, los titulares de ITIN pueden congelar los 3 burós de crédito gratis. Aprende exactamente cómo colocar, levantar y administrar un congelamiento de crédito sin un SSN en 2026."
tier: detail
targetQuery: "cómo congelar tu crédito con un ITIN"
relatedQueries:
  - "puedo congelar mi crédito sin SSN"
  - "congelamiento de crédito para titular de ITIN"
  - "cómo colocar un congelamiento de seguridad con ITIN"
  - "el congelamiento de crédito afecta el puntaje ITIN"
...
faqs:
  ...
  - q: "¿Un congelamiento de crédito perjudica mi puntaje?"
    a: "No. Colocar, levantar o eliminar un congelamiento de seguridad no tiene ningún impacto en tu puntaje de crédito. Tus cuentas actuales continúan reportando tu historial de pagos de manera normal, y los prestamistas con quienes ya tienes cuentas pueden seguir accediendo a tu expediente para fines de administración de cuenta."
  - q: "¿Cuánto tiempo dura un congelamiento de crédito para un titular de ITIN?"
    a: "Un congelamiento de seguridad permanece vigente de manera indefinida hasta que tú mismo lo levantes o lo elimines. No vence automáticamente. Tendrás que levantarlo temporalmente cada vez que quieras solicitar crédito nuevo, lo cual puedes hacer en línea o por teléfono en tan solo una hora."
  - q: "¿Cuál es la diferencia entre un congelamiento de crédito y una alerta de fraude para titulares de ITIN?"
    a: "Un congelamiento de crédito bloquea por completo el acceso de nuevos prestamistas a tu reporte de crédito para abrir una cuenta. Una alerta de fraude deja tu reporte accesible, pero pide a los prestamistas que tomen pasos adicionales para verificar tu identidad antes de otorgar crédito. Una alerta de fraude inicial dura un año y, al colocarla en un buró, notifica automáticamente a los otros dos. Un congelamiento debe colocarse en los tres burós por separado."
  - q: "¿Un congelamiento de crédito detiene todo el robo de identidad?"
    a: "No. Un congelamiento es muy efectivo para evitar que se abran cuentas de crédito fraudulentas a tu nombre, pero no te protege contra el robo de cuentas existentes, el fraude fiscal ni el robo de identidad médica, ya que esos casos no requieren una consulta de crédito. Combinar el congelamiento con un monitoreo continuo de crédito te da una protección más completa."
published: true
---
...
1. Comienza con **Equifax** en línea en my.equifax.com (ingresa tu ITIN donde pide el SSN).
2. Intenta con **Experian** en línea en experian.com/freeze. Si no funciona, envía tus documentos por correo postal a la dirección indicada arriba.
3. Crea una cuenta en el Centro de Servicio de **TransUnion** en línea o llama a su línea de congelamientos.
4. Confirma cada congelamiento revisando el correo electrónico de confirmación, la carta o la actualización de estado en tu cuenta del buró.
5. Guarda tus credenciales de acceso a cada buró en un lugar seguro para poder levantar el congelamiento rápidamente cuando lo necesites.
