---
title: "Cómo transferir tu historial de crédito del ITIN al SSN"
description: "Sí, tu historial de crédito del ITIN se puede transferir a tu nuevo SSN, pero no ocurre de forma automática. Aprende el proceso exacto de 4 pasos para proteger cada mes de crédito que construiste."
tier: detail
...
relatedQueries:
  ...
  - "el historial de crédito del ITIN se pasa al SSN automáticamente"
  - "transferir crédito de ITIN a SSN en las agencias de crédito"
...
faqs:
  ...
  - q: "¿La transferencia con las agencias de crédito ocurre automáticamente cuando obtengo un SSN?"
    a: "No. Tu historial de crédito del ITIN no se transfiere de forma automática. Debes contactar por escrito a las tres agencias, Experian, TransUnion y Equifax, para solicitar la fusión. Sin este paso, tu archivo de crédito puede quedarse huérfano bajo tu antiguo ITIN."
  - q: "¿Necesito cancelar mi ITIN antes de solicitar la transferencia de crédito?"
    a: "Sí. Según las reglas del IRS, no puedes tener un ITIN activo y un SSN activo al mismo tiempo. Primero contacta al IRS para que cancelen tu ITIN, obtén la confirmación por escrito y luego usa esa carta cuando escribas a las agencias de crédito."
  - q: "¿Cuánto tardan las agencias de crédito en fusionar mis archivos del ITIN y del SSN?"
    a: "La mayoría de las agencias de crédito completan la transferencia entre 30 y 60 días después de recibir tu solicitud escrita. Es posible que te envíen una carta de confirmación; si te piden documentos adicionales, responde rápido para evitar demoras."
  - q: "¿Qué documentos necesito enviar a las agencias de crédito para la transferencia del ITIN al SSN?"
    a: "Por lo general necesitarás: tu nombre legal completo, tu ITIN anterior, tu nueva tarjeta de Seguro Social (o confirmación del SSN), una identificación oficial con foto, comprobante de domicilio actual (recibo de servicios o estado de cuenta bancario) y una copia de la carta del IRS que confirma que tu ITIN fue cancelado."
published: true
---
...
| Tarea | A quién contactar | Plazo |
|---|---|---|
| Cancelar ITIN y solicitar la combinación de registros fiscales | IRS (por teléfono o en persona) | Antes que cualquier otro paso |
| Actualizar el SSN con cada prestamista | Bancos, emisores de tarjetas, administradores de préstamos | Dentro de los primeros días de obtener el SSN |
| Enviar cartas de solicitud de transferencia | Las 3 agencias de crédito (correo certificado) | Después de tener en mano la carta de confirmación del IRS |
| Confirmar que la fusión se completó | Consultar los 3 reportes de crédito | 4-8 semanas después de las cartas a las agencias |
| Disputar cuentas faltantes | Agencia(s) correspondiente(s) | De inmediato si el historial está incompleto |
