...
5. **Verifica que cualquier prestamista con quien trabajes reporte tu información bajo tu ITIN correctamente.** Una discrepancia entre el ITIN en la cuenta y el de tu expediente de crédito es un problema de [expediente de crédito mixto](/es/articles/mixed-credit-file-itin-holder) que puede tanto ocultar el fraude como dañar tu puntaje.
