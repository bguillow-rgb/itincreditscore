...
relatedQueries:
  - "qué es un expediente de crédito delgado para titulares de ITIN"
  - "inmigrante invisible al crédito con ITIN"
  - "cómo engrosar mi historial de crédito con ITIN"
  - "no tengo suficiente historial de crédito con ITIN"
...
faqs:
  ...
  - q: "¿Un expediente de crédito delgado es lo mismo que mal crédito?"
    a: "No. Un expediente delgado significa que no hay suficiente información para evaluarte correctamente, no que tu historial sea negativo. Alguien con mal crédito tiene un largo historial de pagos tardíos o incumplimientos. Alguien con un expediente delgado simplemente no tiene suficientes cuentas registradas. Los prestamistas tratan ambas situaciones como riesgo, pero resolver un expediente delgado generalmente es más rápido y no requiere disputar marcas negativas."
  - q: "¿Mi historial crediticio extranjero cuenta para mi expediente de crédito en EE. UU.?"
    a: "No. Los tres principales burós de crédito de EE. UU., Experian, TransUnion y Equifax, no importan registros de burós extranjeros. Tu historial de crédito de México, India, Brasil o cualquier otro país comienza desde cero en el sistema estadounidense. Un servicio llamado Nova Credit puede traducir tu historial extranjero para un número limitado de prestamistas participantes, pero no crea un expediente de crédito en EE. UU. ni un puntaje FICO."
  - q: "¿Cuánto tiempo tarda pasar de un expediente delgado a un expediente con puntaje usando un ITIN?"
    a: "La mayoría de los burós pueden generar un puntaje inicial después de 3-6 meses de actividad reportada en la cuenta. Usando dos cuentas que acepten ITIN al mismo tiempo, como un préstamo para construir crédito más una tarjeta asegurada, puedes llegar a un expediente con puntaje en tan solo tres meses. Alcanzar un buen rango de puntaje (670 o más) generalmente toma entre 12 y 18 meses de pagos puntuales y consistentes."
  - q: "¿Consultar mi propio puntaje de crédito afecta mi expediente delgado?"
    a: "No. Consultar tu propio puntaje o reporte se clasifica como una consulta suave y no tiene ningún impacto en tu puntaje de crédito, ni siquiera con un expediente delgado. Puedes hacerlo con la frecuencia que quieras. Solo las consultas duras generadas por una nueva solicitud de crédito pueden bajar temporalmente tu puntaje, y aun así afectan menos a un expediente delgado que a uno con más historial."
  - q: "¿El reporte de renta puede ayudar a solucionar un expediente de crédito delgado con ITIN?"
    a: "Sí. Los servicios de reporte de renta como Rental Kharma o Boom reportan tus pagos mensuales de renta a uno o más burós. Dado que los titulares de ITIN no siempre pueden acceder de inmediato a productos de crédito tradicionales, el reporte de renta es una de las formas más rápidas de agregar un historial de pagos positivo a un expediente delgado, sin una consulta dura ni depósito."
published: true
---
...
|---|---|---|---|
| Sin expediente (invisible al crédito) | No | No | Abrir una cuenta que reporte actividad de inmediato |
| Expediente delgado, menos de 6 meses | Sí, limitado | A veces (solo VantageScore) | Mantener activas las cuentas existentes y agregar una más |
| Expediente delgado, 6-12 meses | Sí | Generalmente sí | Agregar un segundo tipo de cuenta y reportar renta |
| Expediente establecido, más de 12 meses | Sí, completo | Sí, de forma confiable | Optimizar la utilización y los tiempos de pago |
...
El método más confiable es obtener tu reporte de cada buró por separado. Los tres principales burós de crédito, Experian, Equifax y TransUnion, trabajan con titulares de ITIN y generan reportes basados en tu comportamiento financiero. La única diferencia es el método de acceso. Equifax permite el registro en línea en myEquifax.com, donde ingresas tu ITIN en el campo de SSN y recibes un VantageScore y reporte gratuitos. Para Experian y TransUnion, los titulares de ITIN pueden necesitar enviar solicitudes por correo junto con una identificación emitida por el gobierno y un comprobante de domicilio. Las instrucciones completas paso a paso están en nuestra [guía para obtener tu reporte de crédito gratuito con un ITIN](/es/articles/how-to-check-credit-score-with-itin-number).
...
Una vez que tu expediente alcance 12 meses de historial con dos o más cuentas al corriente, probablemente tendrás un perfil con puntaje en los tres burós y podrás comenzar a enfocarte en los pasos de optimización que se cubren en nuestra guía sobre [cómo subir tu puntaje de crédito con un ITIN](/es/articles/how-to-raise-credit-score-with-itin).
